...
Обычный запуск:
```
OMP_NUM_THREADS=1  ./integrate 1
OMP_NUM_THREADS=40 ./integrate 40
```

С привязкой к одной NUMA-ноде
```
OMP_NUM_THREADS=16 numactl -N 0 ./integrate 16
```
...
for t in 1 2 4 7 8 16 20 40; do
    ...
    OMP_NUM_THREADS=$t numactl -N 0 ./integrate $t
done

# Без привязки
for t in 1 2 4 7 8 16 20 40; do
    echo "===== threads=$t (WITHOUT numactl) ====="
    OMP_NUM_THREADS=$t ./integrate $t
done
```
