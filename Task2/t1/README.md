...
```
OMP_NUM_THREADS=1  numactl -N 0 ./matvec 20000 1
OMP_NUM_THREADS=40 numactl -N 0 ./matvec 40000 40
```

Без привязки к ноде:
```
OMP_NUM_THREADS=40 ./matvec 40000 40
```
...
### Компиляция
```
g++ -O3 -fopenmp -std=c++17 -march=native -Wall matvec.cpp -o matvec
```